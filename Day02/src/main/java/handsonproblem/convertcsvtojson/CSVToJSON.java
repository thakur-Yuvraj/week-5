package handsonproblem.convertcsvtojson;
...
public class CSVToJSON {
    public static void main(String[] args) {
        String csvFilePath = "src/main/java/handsonproblem/convertcsvtojson/students.csv";
        String jsonFilePath = "src/main/java/handsonproblem/convertcsvtojson/students_output.json";
